...
import 'package:cuidapet_api/application/database/i_database_connection_impl.dart'
    as _i7;
import 'package:cuidapet_api/application/logger/i_logger.dart' as _i11;
...
import 'package:cuidapet_api/modules/user/data/i_user_repository_impl.dart'
    as _i10;
import 'package:cuidapet_api/modules/user/service/i_user_service.dart' as _i12;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i4.ICategoriesService>(
        () => _i5.ICategoriesServiceImpl());
    gh.lazySingleton<_i6.IDatabaseConnection>(() =>
        _i7.IDatabaseConnectionImpl(gh<_i8.DatabaseConnectionConfiguration>()));
    gh.lazySingleton<_i9.IUserRepository>(() => _i10.IUserRepositoryImpl(
          connection: gh<_i6.IDatabaseConnection>(),
          log: gh<_i11.ILogger>(),
        ));
    gh.lazySingleton<_i12.IUserService>(() => _i13.IUserServiceImpl(
          userRepository: gh<_i9.IUserRepository>(),
          log: gh<_i11.ILogger>(),
        ));
    gh.factory<_i14.UserController>(() => _i14.UserController(
          userService: gh<_i12.IUserService>(),
          log: gh<_i11.ILogger>(),
        ));
